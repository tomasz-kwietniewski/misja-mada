...
(function () {
  ...
  const INDEX = [
    // STRONA GŁÓWNA
    { page: 'Strona główna',  url: 'index.html',                       title: 'Fundacja Misja MADA',                  body: 'Miłość, Akceptacja bliźniego, Dobroczynność, Adoracja Boga. Służymy drugiemu człowiekowi przez pomoc misyjną, dzieła miłosierdzia i nadzieję płynącą z Ewangelii. Wspieramy Siostry Małe Misjonarki Miłosierdzia (Siostry Orionistki) posługujące dzieciom na Madagaskarze.' },
    { page: 'Strona główna',  url: 'index.html#misja',                 title: 'Nasza misja na Madagaskarze',          body: 'Jesteśmy małżeństwem misjonarzy świeckich. Wspieramy Siostry Małe Misjonarki Miłosierdzia w ich codziennej posłudze najuboższym. 130+ dzieci w Adopcji Serca, 300+ posiłków wydawanych każdego dnia.' },
    { page: 'Strona główna',  url: 'index.html#misja',                 title: 'Założyciele',                          body: 'Małżeństwo misjonarzy świeckich, których droga rozpoczęła się od Adopcji Serca dwójki dzieci z Madagaskaru. Łącząc codzienną pracę zawodową z misją, budują pomost solidarności między Polską a Czerwoną Wyspą.' },
    { page: 'Strona główna',  url: 'index.html#co-robimy',             title: 'Adopcja Serca - 70 zł miesięcznie',    body: 'Tyle wystarcza, by zmienić życie jednego dziecka. Adopcja Serca to długoterminowe wsparcie konkretnego dziecka z Madagaskaru - pokrywa edukację, codzienny ciepły posiłek, mundurek szkolny i podstawową opiekę medyczną.' },
    { page: 'Strona główna',  url: 'index.html#obszary',               title: 'Lista obszarów działań',               body: 'Działania misyjne w Polsce, Wsparcie dzieci, Edukacja i nauka, Walka z głodem - cztery filary codziennej pracy fundacji.' },
    { page: 'Strona główna',  url: 'index.html#footer-konta',          title: 'Konta bankowe - PLN, EUR, GBP',        body: 'Numery kont PLN 70 1090 1056 0000 0001 5832 5871. Odbiorca: Fundacja Misja MADA, ul. Szosa Chełmińska 271A, 87-100 Toruń. Tytuł przelewu: Darowizna na cele statutowe.' },
